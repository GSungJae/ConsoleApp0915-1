...
{
    public class ArrayProgramAccount
    {
        ...
        #region ctor
        public ArrayProgramAccount()
        {
            balance = 0;
        }
        public ArrayProgramAccount(string accname)
        {
            Name = accname;
        }
        #endregion
        ...
        */
        ...
        public static void SetInterest(double interest)//이자율 변경 메소드자체를 정적으로(static)으로 만들거나 클래스명.정적멤버 형식으로 접근하는 방법이 있음 정적은 정적만 접근 가능.
        {
            ...
            ArrayProgramAccount.interest = interest;
        }
        //메서드
        #endregion
    ...
    class ArrayProgram
    {
        ...
        {
            ArrayProgramAccount acc0 = new ArrayProgramAccount();  // ()안에 string 값이 들어가냐 안들어가냐에 따라서 달라짐.
